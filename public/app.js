document.addEventListener('DOMContentLoaded', function() {
    ...
    const dbName = 'cleanCamDB'; // Changed to match Project 2's database name
    ...
    request.onsuccess = function(event) {
        ...
        function capturePhoto() {
            ...
            // Save the captured photo to IndexedDB
        ...
        function savePhoto(imageData) {
            ...
            let request = objectStore.add({ image: imageData });
        ...
        function displayPhotos() {
            ...
            objectStore.openCursor().onsuccess = function(event) {
                ...
                if (cursor) {
                    ...
                    console.log('Photos retrieved from IndexedDB:', photos);
                    renderPhotos(photos);
                }
            };

            transaction.onerror = function(event) {
                console.error('Error opening transaction to display photos:', event.target.error);
            };
        }
